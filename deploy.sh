...
# main config
PLUGINSLUG="milestone"
CURRENTDIR=`pwd`
MAINFILE="fergcorp_milestone.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/milestone/" # Remote SVN repo on wordpress.org, with no trailing slash
SVNUSER="fergbrain" # your svn username
